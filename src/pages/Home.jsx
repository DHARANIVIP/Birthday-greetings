                ...
                <div className="content">
                    <div className="left">
                        ...
                        <div className="btn flex md:gap-2 md:flex-row flex-col">
                            ...
                            <div id="MemoriesWallBtn">
                                <Link to={'/memories'} className="flex items-center gap-2 md:text-[1rem] text-sm">
                            ...
                            <div id="GiftsBtn">
                                <Link to={'/gifts'} className="flex items-center gap-2 md:text-[1rem] text-sm">
                                    <svg className='w-7 h-7' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
